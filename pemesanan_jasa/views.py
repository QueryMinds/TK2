            ...
            try:
                ...
                with connection.cursor() as cursor:
                    try:
                        ...
                        cursor.execute("ALTER TABLE pemesanan_jasa_pemesananjasa DISABLE TRIGGER before_insert_update_tr_pemesanan_jasa;")
                        ...
                        # Re-enable trigger
                        cursor.execute("ALTER TABLE pemesanan_jasa_pemesananjasa ENABLE TRIGGER before_insert_update_tr_pemesanan_jasa;")
